...
const projects: ProjectCardProps[] = [
    {
        id: 1,
        title: 'Personal Site',
        description: "This is what you are viewing currently, a project to show off stuff I like to do, and stuff I've built over time.",
    ...
    },
    {
        id: 2,
        title: 'Todo CLI',
        description: 'Simple Todo CLI tool where you can add, delete, list and prioritize your tasks in a cli. Can be ran on both windows and linux, but I have yet to add auto addition to PATH, will be working on that next',
    ...
    },
    {
        ...
        description: '@radhirasho/latest is a Node.js utility that checks the latest version of a given package from npm or other registries. It can be used as a CLI tool or as a library in your Node.js projects.',
            ...
            <div className="mb-8 flex flex-wrap justify-center gap-4">
                {allCategories.map(category => (
                    <button
                        ...
                        className={`rounded-full px-4 py-2 ${filter === category
