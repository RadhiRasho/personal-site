...
export function Section({ imageAlt, image, content, reverse = false, sizes }: SectionProps) {
  return (
    <div
    ...
    >
      ...
      <p className="flex w-full items-baseline text-xs leading-5 md:text-sm lg:w-3/5">{content}</p>
    </div>
  );
}
