			...
			<NavigationMenu className="pr-2 flex flex-row justify-between">
				<NavigationMenuList className="gap-1">
					...
					<NavigationMenuItem>
						...
						>
							<Github strokeWidth={1.75} size={30} className="hover:text-red-500 text-xs" />
						</Link>
					</NavigationMenuItem>
					<NavigationMenuItem>
						<Link
						...
						>
							<Twitter strokeWidth={1.75} size={30} className="hover:text-red-500 text-xs" />
						</Link>
					</NavigationMenuItem>
					<NavigationMenuItem>
						<Link
						...
						>
							<Linkedin strokeWidth={1.75} size={30} className="hover:text-red-500 text-xs" />
						</Link>
					</NavigationMenuItem>
				</NavigationMenuList>
			</NavigationMenu>
